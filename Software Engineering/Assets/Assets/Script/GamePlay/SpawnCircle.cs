...
public class SpawnCircle : MonoBehaviour {
    ...
    void Start () {
        ...
        distance = Vector3.Distance(player.nonActive.transform.position, player.active.transform.position);//the player width
    ...
    void SpawnCircles()
    {
        ...
        objAhead.transform.position = player.active.transform.position + new Vector3(tmpx, tmpy, 0) * Random.Range(0.9f,1.1f);
        //ChangeColor();
